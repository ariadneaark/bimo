...
<body>
    ...
    <?php
		try{
			...
			{ 
				$id_parceiro = $linhas['id_parceiro'];
					$nome_empresa = $linhas['nome_empresa'];
					$ramo_atividade = $linhas['ramo_atividade'];
					$localizacao = $linhas['localizacao'];
				            ...
				            <div class='twt-feed blue-bg'>
				                ...
				                <div class='media'>
				                    ...
				                    <div class='media-body'>
				                        <h2 class='text-white display-6'>$nome_empresa</h2>
				                        <p class='text-light'>$ramo_atividade</p>
				                    </div>
				                </div>
				            </div>
				        </section>

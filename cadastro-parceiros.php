                ...
                <div class="login-form">
                    <form  method="post">
                        <div class="form-group">
                            <label>Empresa</label>
                            <input type="nome" class="form-control" placeholder="Nome da Empresa">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="texto" class="form-control" placeholder="Localização">
                        </div>
                          <br>
                        <a href="lista-parceiros.php" class="btn btn-success btn-flat m-b-30 m-t-30">Registrar</a>
                    </form>
                </div>
            </div>
        </div>
